  ...
  while($row = mysqli_fetch_row($exec))
  {
    ...
    echo'<div class="container" >';
      echo'<div class="card hoverable large article" id="'.$blog_id.'">';
        ...
        echo'</p>';
          echo'</div>';
        echo'<a class="btn-floating btn-large btn-medium btn-small waves-effect waves-light green" style="margin-left:20px;margin-top:20px;" onclick="approveBlog('.$blog_id.')" href="javascript:void(0);"><i class="material-icons">add</i></a>';
